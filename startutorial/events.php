...
<body>
	<p align="center"><a href="index.php">Click here</a> to go to the 'Customers' Star Tutorial</p>
    <div class="container">
    		<div class="row">
    			<h3>Events</h3>
    		</div>
					   ...
					   $sql = 'SELECT * FROM events ORDER BY id DESC';
	 				   foreach ($pdo->query($sql) as $row) {
								...
								echo '<td width=250>';
							   	...
							   	echo '&nbsp;';
							   	echo '<a class="btn btn-danger" href="event_delete.php?id='.$row['id'].'&date='.$row['event_date'].'">Delete</a>';
							   	echo '</td>';
							   	echo '</tr>';
					   }
					   Database::disconnect();
