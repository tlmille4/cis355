...
{	
	...
	public function displayUserNavigation()
	{
	  ...
	  <a href="editProfile.php">Edit User Profile Info</a></p>';
	}
	
	public function displayLoginForm()
	{
		echo '<div id="welcomeMsg"><form action=index.php method=post><table><tr><td style="border:hidden;"><a href=registration/register.php>Register a New Account</a><tr><br><td style="border:hidden;">Username :<td style="border:hidden;"><input class=textInput name=username><tr><td style="border:hidden;">Password :<td style="border:hidden;"><input class=textInput name=password type=password><tr><td style="border:hidden;"><td style="border:hidden;"><input class="In Log"name=login_btn type=submit></table></form></div>';
	}
