...
if (isset($_POST['courses']))
{
	...
	$sql = "SELECT courses_available FROM courses WHERE courses_id = '$removeCourse'";
	...
	//Update count to allow for another registration
	$availnum = $availnum + 1;
	$sql = "UPDATE courses SET courses_available='$availnum' WHERE courses_id = '$removeCourse'";
	mysqli_query($db,$sql);
	
	
	//Delete course from enrolled table
